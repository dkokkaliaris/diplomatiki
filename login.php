...
<div class="container">
  <div class="row">
    ...
    <h5>Για να συνδεθείτε στο σύστημα αξιολόγησης εκπαιδευτικών προγραμμάτων (i-evaluation), παρακαλούμε επιλέξτε έναν από τους παρακάτω διαθέσιμους τρόπους, επιλέγοντας τον κατάλληλο υπερσύνδεσμο που εμφανίζεται στην παρακάτω λίστα:
    </h5>
